...
class AuthenticatableDestroyController
{
    ...
    public function destroy(): void
    {
        ...
        $deleted = $authenticatable->delete();

        if ($deleted !== true) {
            throw new \RuntimeException('Unable to delete authenticatable');
        }
    }
    ...
    {
        return Assert::string($this->getRoute()->defaults['scope'] ?? 'authenticatable_destroy');
    }
    ...
    {
        $ability = $this->getRoute()->defaults['verification_ability'] ?? false;
