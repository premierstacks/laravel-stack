...
return [
    VerificationNotification::class => [
        'token' => [
            ...
            'line_3_title' => 'Verification symbols:',
            'line_3' => 'These symbols verify that this email is genuinely related to your request. On the confirmation page, you will see the same symbols: :pair',
