...
return [
    VerificationNotification::class => [
        'token' => [
            ...
            'line_3_title' => 'How to proceed:',
            'line_3' => 'Click the button below and follow the instructions on the page. The button will redirect you to a page where you can safely confirm the action.',
